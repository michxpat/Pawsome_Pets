...
createStaffMemberTable = """
 ...
 """
cursor.execute(createStaffMemberTable)
...
"""
cursor.execute(createOwnerTable)
...
"""
cursor.execute(createPetTable)


createExaminationTable = """
...
"""
cursor.execute(createExaminationTable)
